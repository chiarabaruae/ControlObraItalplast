...
- Completar una tarea exige una **evidencia**: imagen, documento (PDF, Word, Excel, CSV, texto) o un enlace externo (D-031). La observación es opcional, pero si se escribe debe tener al menos 50 caracteres.
